...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    -- Cursor({ bg = c.base.white }), -- Character under the cursor
    -- CurSearch      { }, -- Highlighting a search pattern under the cursor (see 'hlsearch')
    -- lCursor        { }, -- Character under the cursor when |language-mapping| is used (see 'guicursor')
    -- CursorIM       { }, -- Like Cursor, but used when in IME mode |CursorIM|
    CursorColumn { fg = c.base.red },                    -- Screen-column at the cursor, when 'cursorcolumn' is set.
    CursorLine { bg = hsl(c.ui.background).lighten(4) }, -- Screen-line at the cursor, when 'cursorline' is set. Low-priority if foreground (ctermfg OR guifg) is not set.
    Directory { fg = c.base.violet },                    -- Directory names (and other special names in listings)
    DiffAdd { fg = c.base.green },                       -- Diff mode: Added line |diff.txt|
    DiffChange { fg = c.base.pink },                     -- Diff mode: Changed line |diff.txt|
    ...
    VertSplit { bg = c.base.red, fg = c.ui.background }, -- Column separating vertically split windows
    ...
    MoreMsg { fg = c.base.purple },                            -- |more-prompt|
    -- NonText        { }, -- '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
    Normal { bg = c.ui.background, fg = hsl "#8e95b4" },       -- Normal text
    -- NormalFloat    { }, -- Normal text in floating windows.
    FloatBorder { fg = c.base.violet },                        -- Border of floating windows.
    -- FloatTitle { bh = c.base.red },                            -- Title of floating windows.
    -- NormalNC {},                                               -- normal text in non-current windows
    Pmenu { bg = c.ui.shade1 },    -- Popup menu: Normal item.
    PmenuSel { bg = c.ui.shade2 }, -- Popup menu: Selected item.
    ...
    QuickFixLine { fg = c.base.cyan }, -- Current |quickfix| item in the quickfix window. Combined with |hl-CursorLine| when the cursor is there.
    ...
    Title { fg = c.base.violet },     -- Titles for output from ":set all", ":autocmd" etc.
    ...
    WildMenu { bg = c.base.purple, fg = c.ui.background }, -- Current match in 'wildmenu' completion
    WinBar { fg = c.base.violet },                         -- Window bar of current window
